 ...
 */
  [LAYER_NUMERAL] = LAYOUT_split_3x5_3(
    ...
    KC_LCTL, KC_LSFT, KC_LALT, KC_LGUI, XXXXXXX, LSFT(KC_EQL), KC_4, KC_5,   KC_6, KC_MINS,
    XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_DOT,       KC_1, KC_2,   KC_3, KC_EQL,
                      XXXXXXX, _______, XXXXXXX, KC_ENT,       KC_0, KC_BSPC
  ),
